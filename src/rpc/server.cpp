...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"wallet", "getsha256", &getsha256, true, false, true},
        {"wallet", "getshieldbalance", &getshieldbalance, true, false, true},
        {"wallet", "listreceivedbyshieldaddress", &listreceivedbyshieldaddress, true, false, true},
        {"wallet", "importsaplingkey", &importsaplingkey, true, false, true},
        {"wallet", "exportsaplingkey", &exportsaplingkey, true, false, true},
        {"wallet", "getnewshieldaddress", &getnewshieldaddress, true, false, true},
        {"wallet", "shieldsendmany", &shieldsendmany, true, false, true},
        {"wallet", "listshieldunspent", &listshieldunspent, true, false, true},
