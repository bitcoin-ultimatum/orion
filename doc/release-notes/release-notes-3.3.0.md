BTCU Core version *3.3.0* is now available from:  <https://github.com/btcu-project/btcu/releases>
...
Several new commands were added in v2.3.1 to replace the two aforementioned commands, reference the [v2.3.1 Release Notes](https://github.com/BTCU-Project/BTCU/blob/master/doc/release-notes/release-notes-2.3.1.md#rpc-changes) for further details.
