BTCU Core version *3.1.0.2* is now available from:  <https://github.com/btcu-project/btcu/releases>
...
### Users upgrading to this version are encouraged to also read the detailed release notes for the previous [3.1.0](https://github.com/BTCU-Project/BTCU/releases/tag/v3.1.0) release as information will not be duplicated here.
