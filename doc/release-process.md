...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/bitcoin-ultimatum/orion/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/bitcoin-ultimatum/orion/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/bitcoin-ultimatum/orion.git --recursive
...
- Detached signatures will then be committed to the [btcu-detached-sigs](https://github.com/bitcoin-ultimatum/orion-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/bitcoin-ultimatum/orion/releases/new) with a link to the archived release notes.
