...
The script [extract-osx-sdk.sh](https://github.com/bitcoin-ultimatum/ours/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bitcoin-ultimatum/ours/blob/master/doc/README_osx.md) for troubleshooting tips.