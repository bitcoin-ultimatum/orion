...
Download from [Releases](https://github.com/bitcoin-ultimatum/ours/releases) latest version, unpack the files into a directory and run:
...
* See the documentation at the [BTCU Wiki](https://github.com/bitcoin-ultimatum/ours/wiki)
